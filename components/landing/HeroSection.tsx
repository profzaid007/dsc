...
export function HeroSection() {
  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div
        className="animate-hero-gradient absolute inset-0 z-0"
        style={{
          background:
            "linear-gradient(135deg, #0a3d62, #1a5276, #2e86c1, #3c8dbc, #c9a227, #e6c200, #c9a227, #3c8dbc, #2e86c1, #1a5276, #0a3d62)",
      ...
      <div className="relative z-10 mx-auto flex max-w-5xl flex-col items-center px-6 text-center">
        ...
        <div className="animate-fade-in-up mb-10">
          <div className="relative flex h-[180px] w-[180px] items-center justify-center md:h-[220px] md:w-[220px]">
            {/* Outer glow rings */}
            <div className="animate-pulse-ring absolute left-1/2 top-1/2 h-[180px] w-[180px] rounded-full border border-white/20 md:h-[220px] md:w-[220px]" />
            ...
            {/* Logo container */}
            <div className="relative z-10 flex h-[150px] w-[150px] items-center justify-center rounded-full border-2 border-white/30 bg-white/10 shadow-2xl backdrop-blur-sm md:h-[180px] md:w-[180px]">
              <div className="flex h-[120px] w-[120px] items-center justify-center rounded-full border border-white/20 bg-white/5 md:h-[150px] md:w-[150px]">
                <Image
                  src="/logo.svg"
                  alt="DSC Logo"
                  width={90}
        ...
        {/* Headline */}
        <h1 className="animate-fade-in-up delay-200 text-3xl font-bold leading-tight tracking-tight text-white drop-shadow-lg md:text-5xl lg:text-6xl">
          {t(SITE_CONTENT.hero.headline, lang)}
        </h1>

        {/* Subheadline */}
        <p className="animate-fade-in-up delay-400 mx-auto mt-6 max-w-2xl text-base leading-relaxed text-white/80 md:text-lg lg:text-xl">
      ...
      <div className="absolute bottom-0 left-0 z-[3] h-32 w-full bg-gradient-to-t from-white to-transparent" />
    </section>
  )
}
