...
import type { ToolType, ReportConfig } from "@/types/tool"
...
export default function ReportViewPage({ params }: ToolViewPageProps) {
  ...
  const config = tool?.config as ReportConfig | undefined
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Link href={`/dashboard/admin/tools/report/edit/${toolId}`}>
