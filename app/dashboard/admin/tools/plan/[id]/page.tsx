...
import type { ToolType, PlanConfig } from "@/types/tool"
...
export default function PlanViewPage({ params }: ToolViewPageProps) {
  ...
  const config = tool?.config as PlanConfig | undefined
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Link href={`/dashboard/admin/tools/plan/edit/${toolId}`}>
