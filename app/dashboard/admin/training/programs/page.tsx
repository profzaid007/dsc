  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button
          onClick={() =>
            router.push("/dashboard/admin/training/programs/new")
          }
        >
        ...
        <CardContent>
          ...
          {filteredPrograms.length === 0 ? (
            ...
            <ProgramTable
              ...
              onView={(id) =>
                router.push(`/dashboard/admin/training/programs/${id}`)
              }
              onEdit={(id) =>
                router.push(`/dashboard/admin/training/programs/${id}?edit=true`)
              }
